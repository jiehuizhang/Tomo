...
%
% This example computes unary potentials, edge weightsm and edge classes

% dataset from CVPR 2011: S. Jegelka and J. Bilmes. "Submodularity beyond submodular energies: coupling edges in graph cuts"
imageName = {'001_oct', '002_scarf', '003_comb', '3openCV_Result', '004_key', '005_bee', '006_insectjaw', ...
                '007_insectjaw', '008_mouse', '009_lamp', '010_blackbeetle', '012_greybeetle', ...
                '014_bamboo', '017_darktree', '019_redtree1', '020_smallplant', '028_darklamp','Gaussian', 'mdb222', 'test_eq_denoisedresize'  };
